...
public final class PsafeConfigGroup extends ReflectiveConfigGroup{
	...
	private static final String INPUT_PERCEIVED_SAFETY_ESCOOT_SD = "marginalUtilityOfPerceivedSafety_escoot_m_sd";
    ...
    private double marginalUtilityOfPerceivedSafety_car_sd;
    private double marginalUtilityOfPerceivedSafety_ebike_sd;
    private double marginalUtilityOfPerceivedSafety_escoot_sd;
    private double marginalUtilityOfPerceivedSafety_walk_sd;
	...
	public void setMarginalUtilityOfPerceivedSafety_car_m_sd(final double value) {
		this.marginalUtilityOfPerceivedSafety_car_sd = value; // PROSTHESE MONTE CARLO SIMULATION
	}
	@StringGetter( INPUT_PERCEIVED_SAFETY_CAR_SD)
	public double getMarginalUtilityOfPerceivedSafety_car_m_sd() {
		return this.marginalUtilityOfPerceivedSafety_car_sd;
	}
	
	@StringSetter(INPUT_PERCEIVED_SAFETY_EBIKE_SD)
	public void setMarginalUtilityOfPerceivedSafety_ebike_m_sd(final double value) {
		this.marginalUtilityOfPerceivedSafety_ebike_sd = value; // PROSTHESE MONTE CARLO SIMULATION
	}
	@StringGetter( INPUT_PERCEIVED_SAFETY_EBIKE_SD)
	public double getMarginalUtilityOfPerceivedSafety_ebike_m_sd() {
		return this.marginalUtilityOfPerceivedSafety_ebike_sd;
	}
	
	@StringSetter(INPUT_PERCEIVED_SAFETY_ESCOOT_SD)
	public void setMarginalUtilityOfPerceivedSafety_escoot_m_sd(final double value) {
		this.marginalUtilityOfPerceivedSafety_escoot_sd = value; // PROSTHESE MONTE CARLO SIMULATION
	}
	@StringGetter( INPUT_PERCEIVED_SAFETY_ESCOOT_SD)
	public double getMarginalUtilityOfPerceivedSafety_escoot_m_sd() {
		return this.marginalUtilityOfPerceivedSafety_escoot_sd;
	}

	@StringSetter(INPUT_PERCEIVED_SAFETY_WALK_SD)
	public void setMarginalUtilityOfPerceivedSafety_walk_m_sd(final double value) {
		this.marginalUtilityOfPerceivedSafety_walk_sd = value; // PROSTHESE MONTE CARLO SIMULATION
	}
	@StringGetter( INPUT_PERCEIVED_SAFETY_WALK_SD)
	public double getMarginalUtilityOfPerceivedSafety_walk_m_sd() {
		return this.marginalUtilityOfPerceivedSafety_walk_sd;
	}
